...
export const metadata = {
  title: "X vs Y Box Office Comparator India",
  description:
    "Compare Indian movie box-office runs day by day using BollyAI's published India nett trade-estimate rows.",
...
export default function BoxOfficeComparatorPage() {
  ...
  const answer =
    `BollyAI's box-office comparator currently has ${films.length} films with published day-wise India nett rows. It defaults to day-aligned comparisons and keeps missing days blank until the two-source publish rule clears.`;

  return (
    <main className="page-shell tool-shell" data-desk="tollywood">
      <JsonLd
        data={{
      ...
      <section className="content-sections">
        <section className="panel tool-method">
          ...
          <p>
            The comparator uses only published India nett ranges from repo film JSON. Worldwide day-wise gross and
        ...
        <section className="panel">
          ...
          <nav className="mesh-links" aria-label="Tool links">
            ...
            <a href="/tollywood/box-office/peddi-2026/">Peddi tracker</a>
            <a href="/kollywood/box-office/karuppu-2026/">Karuppu tracker</a>
            <a href="/bollywood/box-office/hai-jawani-toh-ishq-hona-hai-2026/">Hai Jawani tracker</a>
          </nav>
        </section>
      </section>
    </main>
